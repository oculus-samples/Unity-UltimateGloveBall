    ...
    public class MainMenuController : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            if (m_currentState == MenuState.Main)
            {
                ...
                if (GUILayout.Button("WATCH MATCH"))
                {
                    OnWatchMatchClicked();
                }
            ...
            else if (m_currentState == MenuState.Options)
            {
            ...
            if (GUILayout.Button("Back"))
            {
                switch (m_currentState)
                {
                    ...
                    case MenuState.Friends:
                        OnFriendsBackClicked();
                        break;
                    case MenuState.Settings:
                        OnSettingsBackClicked();
                        break;
                    case MenuState.BallTypes:
                        OnBallTypesBackClicked();
                        break;
                    default:
