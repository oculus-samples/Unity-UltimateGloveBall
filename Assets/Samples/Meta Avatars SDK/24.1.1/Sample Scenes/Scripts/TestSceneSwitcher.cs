...
#if USING_XR_SDK
        if (OVRInput.GetActiveController().HasFlag(OVRInput.Controller.RTouch) && OVRInput.Get(OVRInput.Button.One, OVRInput.Controller.RTouch))
        {
            sceneChange = 1;
        }
        else if (OVRInput.GetActiveController().HasFlag(OVRInput.Controller.LTouch) && OVRInput.Get(OVRInput.Button.One, OVRInput.Controller.LTouch))
        {
            sceneChange = -1;
        }
#endif
