...
void vert_Vertex_main()
{
    ...
    vin.tangent = ovrData.tangent;
    vin.vertexId = ovrData.vertexId;
    vin.texcoord0 = a_UV1;
    vin.texcoord1 = a_UV2;
    vin.color = a_Color;
    vin.ormt = a_ORMT;
    ...
    v_Normal = normalize(mul(float4(vin.normal, 1.0f), unity_WorldToObject)).xyz;
    v_Tangent = normalize(mul(vin.tangent, unity_WorldToObject));
